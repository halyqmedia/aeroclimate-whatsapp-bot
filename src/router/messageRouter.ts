...
// через Claude, чтобы сработал сценарий приветствия и сбора имени (см. config/business.ts).
...
/**
 * Пытается ответить без обращения к Claude. Возвращает null, если сообщение
